<?php
// PHP functionality will be added here later
// session_start();
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="login-form">
                <div style="text-align: center; margin-bottom: 1.5rem;">
                    <img src="../assets/logo.png" alt="Logo CBT" style="max-width: 80%; height: auto; max-height: 120px;">
                </div>
                ...
                <div class="login-tabs">
                    ...
                    <button class="tab-btn" data-role="student">Peserta</button>
                </div>
                ...
                <form id="login-form" onsubmit="return false;">
                    ...
                    <button type="submit" class="login-btn" id="login-btn">Admin Masuk</button>
                </form>
        ...
        <script src="../assets/logo-utils.js"></script>
        ...
        <script>
            ...
            document.querySelectorAll('.tab-btn').forEach(btn => {
                btn.addEventListener('click', (e) => {
                    ...
                    if (selectedRole === 'admin') {
                        loginBtn.textContent = 'Admin Masuk';
                    } else {
                        loginBtn.textContent = 'Peserta Masuk';
                    }
                });
            });

            // Login form handler - menggunakan autentikasi database
            ...
            if (loginForm) {
                loginForm.addEventListener('submit', async (e) => {
                    ...
                    try {
                        // Import AuthController secara dinamis
