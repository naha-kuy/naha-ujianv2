...
// Cek jika masih ujian aktif - akan ditangani di halaman konfirmasi dengan dialog
$ujian_aktif = false;
                                ...
                                <div class="card shadow">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-start mt-4">
                                            <form action="mulaiujian.php" method="post" class="row g-2 justify-content-start align-items-center" id="formMulaiUjian">
                                                ...
                                                <input type="hidden" name="reset_ujian" id="reset_ujian" value="0">
                                                ...
                                                <div class="col-auto">
                                                    <input type="text" name="token" class="form-control form-control-lg" placeholder="Token" required id="tokenInput">
                                                </div>

                                                <div class="col-auto">
                                                    <button type="submit" class="btn btn-success btn-lg" id="btnMulaiUjian">
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('formMulaiUjian');
    const btnMulai = document.getElementById('btnMulaiUjian');
    const tokenInput = document.getElementById('tokenInput');
    const resetUjianInput = document.getElementById('reset_ujian');

    <?php if ($ujian_aktif): ?>
    // Jika ujian masih aktif, tampilkan konfirmasi reset
    form.addEventListener('submit', function(e) {
        e.preventDefault();

        Swal.fire({
            title: 'Ujian Masih Aktif!',
            html: `
                <div class="text-start">
                    <p>Anda memiliki sesi ujian yang belum selesai untuk soal ini.</p>
                    <p class="text-warning"><strong>⚠️ Peringatan:</strong> Melanjutkan akan mereset status ujian Anda.</p>
                    <p>Jawaban yang sudah disimpan akan tetap ada, namun status ujian akan direset.</p>
                </div>
            `,
            icon: 'warning',
            ...
            confirmButtonText: 'Ya, Reset & Lanjutkan',
            cancelButtonText: 'Batal'
        }).then((result) => {
            if (result.isConfirmed) {
                // Set flag reset dan submit form
                resetUjianInput.value = '1';
                form.submit();
            }
        });
    });
    <?php else: ?>
    // Jika ujian tidak aktif, langsung submit
    form.addEventListener('submit', function(e) {
