...
$reset_ujian = $_POST['reset_ujian'] ?? '0';
...
// Cek jika siswa sudah pernah mengerjakan (hanya jika bukan reset)
if ($reset_ujian !== '1') {
...
if ($w = mysqli_fetch_assoc($get_waktu)) {
    ...
    if ($reset_ujian === '1') {
        // Jika reset, update status yang sudah ada menjadi Aktif
        mysqli_query($koneksi,
            "UPDATE jawaban_siswa SET status_ujian = 'Aktif', waktu_sisa = '$waktu_sisa'
