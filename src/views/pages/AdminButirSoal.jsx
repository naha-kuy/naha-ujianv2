...
export default function AdminButirSoalReadOnly() {
  ...
  const back = () => navigate("/admin/bank-soal");
            ...
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
              <div>
                <button onClick={back} style={{ background: "none", border: "none", cursor: "pointer", color: "#b89440", fontSize: 12, display: "flex", alignItems: "center", gap: 4, marginBottom: 4 }}>
                  <Icon name="chevron-left" size={14} /> Kembali ke Bank Soal
                </button>
                <h1 style={{ fontSize: 17 }}>Butir Soal — {nama_soal} <span style={{ fontSize: 11, color: "#9a7a30", fontWeight: 400 }}>(read-only)</span></h1>
                  ...
                  <tbody>
                    {data.map((q) => (
                      <tr key={q.id_soal}>
                        ...
                        <td>{q.status_soal === "Aktif" ? <span style={{ color: "#28a745", fontWeight: 600, fontSize: 11 }}>Aktif</span> : <span style={{ color: "#b02020", fontWeight: 600, fontSize: 11 }}>Nonaktif</span>}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
