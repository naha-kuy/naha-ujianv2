...
export default function ModalEditGuru({ editForm, saving, onClose, onSave, onChange }) {
  return (
      ...
      <div className="modal-card" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 460 }}>
        <div className="modal-head">
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div>
              <h3 style={{ fontSize: 14, margin: 0 }}>Edit Data Guru</h3>
              <span style={{ fontSize: 10, color: "#9a7a30" }}>Perbarui informasi akun guru</span>
            </div>
          </div>
        ...
        <div className="modal-body" style={{ display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          <div style={{ display: "flex", gap: 12 }}>
            ...
            <div className="input-wrap" style={{ flex: 1 }}>
              ...
              <input type="text" value={editForm.mata_pelajaran || ""}
                onChange={(e) => onChange({ ...editForm, mata_pelajaran: e.target.value })}
